...
import CertificateCard from '@/views/examples/DesignCode/layout/Profile/_components/CertificateCard';
import Info from './_components/Info';
import CourseCard from '@/views/examples/DesignCode/layout/_components/CourseCard';
import Book, {IData} from '@/views/examples/DesignCode/layout/Price/_components/Book';
